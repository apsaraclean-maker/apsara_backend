...
userSchema.index({ business_id: 1, employee_id: 1 }, { unique: true, partialFilterExpression: { employee_id: { $type: 'string' } } });
...
// (null, null) key.
orderSchema.index({ business_id: 1, order_number: 1 }, { unique: true, partialFilterExpression: { order_number: { $type: 'string' } } });
//
